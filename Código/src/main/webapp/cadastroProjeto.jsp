...
<html>
    <head>
        ...
        <title>Cadastro de Projeto - REQ</title>
    </head>
    <body id="body-cadproj">
        ...
        <div id="container">
            ...
            <form id="form-projeto">
                ...
                <br>
                <input type="text" class="title-field" id="title-field" required>
                <br>
                <label for="desc-field">Descrição</label>
                <br>
                <textarea class="desc-field" id="desc-field" rows="5" cols="30" required></textarea>
                <br>
                <div id="acoes">
